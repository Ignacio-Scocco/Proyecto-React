            ...
            <div className="w-full max-w-sm bg-blue-100 rounded-lg shadow-md dark:bg-gray-500 dark:border-gray-700">
                ...
                <div className="px-5 pb-5">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  p-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 no-underline">Agregar a carrito</a>
                    </div>
                </div>
            </div>
